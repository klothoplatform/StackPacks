...
def assume_role(
    sts_client, role_arn, external_id=None
) -> tuple[AssumeRoleCredentials, AssumedRoleUser]:
    assumed_role_object = sts_client.assume_role(
        RoleArn=role_arn, RoleSessionName="StackPackSession", ExternalId=external_id
    )
