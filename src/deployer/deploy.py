...
from src.project import ConfigValues, StackPack, get_stack_packs, get_app_name
...
async def build_and_deploy(
    ...
    try:
        ...
        logger.error(f"Error deploying {app_id} for project {project_id}: {e}", exc_info=True)
        pulumi_stack.update(
            actions=[
