...
export MM_SQLSETTINGS_DATASOURCE="postgres://${MATTERMOST_DB_RDS_USERNAME}:${MATTERMOST_DB_RDS_PASSWORD}@${MATTERMOST_DB_RDS_ENDPOINT}/${MM_DATABASE_NAME}?sslmode=disable&connect_timeout=10"
