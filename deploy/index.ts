...
const ecs_service_0_ecs_service_0_ecr_repo = new aws.ecr.Repository(
...
const ecs_service_0_log_group = new aws.cloudwatch.LogGroup(
  "ecs_service_0-log-group",
  {
...
const ecs_service_0_security_group = new aws.ec2.SecurityGroup(
  "ecs_service_0-security_group",
  {
...
const load_balancer_2_security_group = new aws.ec2.SecurityGroup(
  "load-balancer-2-security_group",
  {
...
const security_group_subnet_0_deploy_logs = new aws.ec2.SecurityGroup(
  "subnet-0-deploy-logs",
  {
...
const security_group_subnet_1_deploy_logs = new aws.ec2.SecurityGroup(
  "subnet-1-deploy-logs",
  {
...
const stack_snap_deploy_logs = new aws.efs.AccessPoint(
  "stack-snap-deploy-logs",
  {
...
const ecs_service_0_execution_role = new aws.iam.Role(
  "ecs_service_0-execution-role",
  {
          ...
          Statement: [
            {
              ...
              Resource: [
                pulumistacks.arn,
                pulumi.interpolate`${pulumistacks.arn}/stream/*`,
                pulumi.interpolate`${pulumistacks.arn}/backup/*`,
                pulumi.interpolate`${pulumistacks.arn}/export/*`,
                pulumi.interpolate`${pulumistacks.arn}/index/*`,
              ],
            },
          ],
          Version: "2012-10-17",
          ...
          Statement: [
            {
              ...
              Resource: [
                userpacks.arn,
                pulumi.interpolate`${userpacks.arn}/stream/*`,
                pulumi.interpolate`${userpacks.arn}/backup/*`,
                pulumi.interpolate`${userpacks.arn}/export/*`,
                pulumi.interpolate`${userpacks.arn}/index/*`,
              ],
            },
          ],
          Version: "2012-10-17",
          ...
          Statement: [
            {
              ...
              Resource: [
                userapps.arn,
                pulumi.interpolate`${userapps.arn}/stream/*`,
                pulumi.interpolate`${userapps.arn}/backup/*`,
                pulumi.interpolate`${userapps.arn}/export/*`,
                pulumi.interpolate`${userapps.arn}/index/*`,
              ],
            },
          ],
          Version: "2012-10-17",
          ...
          Statement: [
            {
              ...
              Resource: [
                deployments.arn,
                pulumi.interpolate`${deployments.arn}/stream/*`,
                pulumi.interpolate`${deployments.arn}/backup/*`,
                pulumi.interpolate`${deployments.arn}/export/*`,
                pulumi.interpolate`${deployments.arn}/index/*`,
              ],
            },
          ],
          Version: "2012-10-17",
          ...
          Statement: [
            {
              Action: ["s3:*"],
              Effect: "Allow",
              Resource: [iac_store.arn, pulumi.interpolate`${iac_store.arn}/*`],
            },
          ],
          Version: "2012-10-17",
        }),
          ...
          Statement: [
            {
              ...
              Effect: "Allow",
              Resource: [
                stack_snap_binaries.arn,
                pulumi.interpolate`${stack_snap_binaries.arn}/*`,
              ],
            },
          ],
          Version: "2012-10-17",
...
const efs_mount_target_subnet_0_deploy_logs = new aws.efs.MountTarget(
  "subnet-0-deploy-logs",
  {
    fileSystemId: deploy_logs.id,
...
const efs_mount_target_subnet_1_deploy_logs = new aws.efs.MountTarget(
  "subnet-1-deploy-logs",
  {
    fileSystemId: deploy_logs.id,
...
const stacksnap = new aws.cloudfront.Distribution("stacksnap", {
  origins: [
    ...
    },
    {
      ...
      domainName: load_balancer_2.dnsName,
...
const load_balancer_2_listener_0 = new aws.lb.Listener(
  "load_balancer_2-listener-0",
  {
...
const stack_snap = new aws.ecs.Service(
  ...
  {
    dependsOn: [
      default_rule_stack_snap,
      ecs_cluster_0,
      ecs_service_0,
      ecs_service_0_security_group,
      subnet_0,
      subnet_1,
    ],
  },
