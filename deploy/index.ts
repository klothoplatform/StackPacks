...
const projects = new aws.dynamodb.Table(
  "projects",
  {
    ...
    hashKey: "id",
    billingMode: "PAY_PER_REQUEST",
    tags: { GLOBAL_KLOTHO_TAG: "", RESOURCE_NAME: "projects" },
  },
  { protect: protect },
);
const pulumi_stacks = new aws.dynamodb.Table(
  "pulumi-stacks",
  {
    ...
    rangeKey: "name",
    billingMode: "PAY_PER_REQUEST",
    tags: { GLOBAL_KLOTHO_TAG: "", RESOURCE_NAME: "pulumi-stacks" },
  },
  { protect: protect },
);
...
const stacksnap_task_log_group = new aws.cloudwatch.LogGroup(
  "stacksnap-task-log-group",
  {
    ...
    retentionInDays: 5,
    tags: { GLOBAL_KLOTHO_TAG: "", RESOURCE_NAME: "stacksnap-task-log-group" },
  },
);
...
const stacksnap_binaries = new aws.s3.Bucket(
  "stacksnap-binaries",
  {
    ...
    tags: { GLOBAL_KLOTHO_TAG: "", RESOURCE_NAME: "stacksnap-binaries" },
  },
  { protect: protect },
);
...
const stacksnap_iac_store = new aws.s3.Bucket(
  "stacksnap-iac-store",
  {
    ...
    tags: { GLOBAL_KLOTHO_TAG: "", RESOURCE_NAME: "stacksnap-iac-store" },
  },
  { protect: protect },
);
...
const stacksnap_ui = new aws.s3.Bucket(
  "stacksnap-ui",
  {
    ...
    tags: { GLOBAL_KLOTHO_TAG: "", RESOURCE_NAME: "stacksnap-ui" },
  },
  { protect: protect },
);
...
const stacksnap_tg = (() => {
  const tg = new aws.lb.TargetGroup("stacksnap-tg", {
    ...
    tags: { GLOBAL_KLOTHO_TAG: "", RESOURCE_NAME: "stacksnap-tg" },
  });
  return tg;
})();
...
const stacksnap_shared_storage = new aws.efs.FileSystem(
  "stacksnap-shared-storage",
  {
    ...
    tags: { GLOBAL_KLOTHO_TAG: "", RESOURCE_NAME: "stacksnap-shared-storage" },
  },
  {
    dependsOn: [],
  },
...
const stacksnap_ecs_task_role = new aws.iam.Role("stacksnap-ecs-task-role", {
  ...
  tags: { GLOBAL_KLOTHO_TAG: "", RESOURCE_NAME: "stacksnap-ecs-task-role" },
});
...
const stacksnap_task = new aws.ecs.TaskDefinition("stacksnap-task", {
  ...
  tags: { GLOBAL_KLOTHO_TAG: "", RESOURCE_NAME: "stacksnap-task" },
});
...
const stacksnap_alb = new aws.lb.LoadBalancer("stacksnap-alb", {
  ...
  tags: { GLOBAL_KLOTHO_TAG: "", RESOURCE_NAME: "stacksnap-alb" },
...
const stacksnap_distribution = new aws.cloudfront.Distribution(
  "stacksnap-distribution",
  {
    ...
    viewerCertificate: {
      acmCertificateArn:
        "arn:aws:acm:us-east-1:338991950301:certificate/de37adbe-563d-4b81-b878-8be0e8175ce4",
...
const stacksnap_alb_listener = new aws.lb.Listener("stacksnap-alb-listener", {
  ...
  port: 80,
  protocol: "HTTP",
  tags: { GLOBAL_KLOTHO_TAG: "", RESOURCE_NAME: "stacksnap-alb-listener" },
});
...
const stacksnap_service = new aws.ecs.Service(
  "stacksnap-service",
  {
    ...
    //TMP
    tags: { GLOBAL_KLOTHO_TAG: "", RESOURCE_NAME: "stacksnap-service" },
  },
  {
    dependsOn: [
