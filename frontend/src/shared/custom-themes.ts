...
export const altTable: CustomFlowbiteTheme["table"] = {
  ...
  head: {
    ...
    cell: {
      base: "bg-gray-100 px-6 py-3 group-first/head:first:rounded-tl-lg group-first/head:last:rounded-tr-lg dark:bg-gray-800",
    },
  },
  row: {
    base: "group/row odd:dark:bg-gray-900 even:dark:bg-gray-900",
