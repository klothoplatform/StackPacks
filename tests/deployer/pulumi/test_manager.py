...
class TestAppManager(aiounittest.AsyncTestCase):
    ...
    async def test_read_deployed_state(self, mock_temp_dir, mock_parse_yaml_raw_as, mock_get_live_state):
        # Arrange
        mock_stack = MagicMock()
        mock_stack.export_stack.return_value.deployment = {"resources": "mock_resources"}
        ...
        mock_get_live_state.assert_called_once_with(GetLiveStateRequest(state="mock_resources", tmp_dir="mock_dir"))
