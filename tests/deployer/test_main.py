...
class TestMyModule(aiounittest.AsyncTestCase):
    ...
    def test_run_build_and_deploy(
        ...
        run_build_and_deploy(None, "region", "arn", "user", b"iac")
    ...
    async def test_build_and_deploy(
        ...
        # Call the method
        await build_and_deploy(mock_queue, "region", "arn", "user", b"iac")
    ...
    def test_run_destroy_loop(
        ...
        # Call the function to test
        run_destroy_loop(None, "region", "arn", "user", b"iac")
        ...
        # Check that build_and_deploy was called with the correct arguments
        mock_run_destroy.assert_called_once_with(None, "region", "arn", "user", b"iac")
    ...
    async def test_run_destroy(
        ...
        # Call the method
        await run_destroy(mock_queue, "region", "arn", "user", b"iac")
