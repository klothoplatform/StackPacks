...
class TestLiveState(aiounittest.AsyncTestCase):
    def test_to_constraints(self):
        # Arrange
        live_state = LiveState(resources=Resources({
            "resource1": Properties({}),
            "resource2": Properties({"Property2": "Value2"}),
            }), edges=Edges())
        stack_pack = Mock(spec=StackPack, base=Mock(resources=Resources({
        ...
        live_state.resources.to_constraints = Mock(return_value=[
        ...
        expected_result = [
            ...
            {"scope": "resource", "operator": "equals", "property": "Property1", "value": "Value1", "target": "resource1"},
            {"scope": "resource", "operator": "equals", "property": "Property2", "value": "Value2", "target": "resource2"},
            {"scope": "edge", "operator": "must_exist", "target": {"source": "resource1", "target": "resource2"}},
        ]
    ...
    def test_region_substituted(self):
        ...
        expected_result = [
            ...
            {"scope": "resource", "operator": "equals", "property": "Property1", "value": "Value1", "target": "aws:region:region"},
        ]
        self.assertEqual(result, expected_result)